...
namespace param_sfo {
 ...
 //index_table_entry has total length 0x10 and gives information about a keys_table_entry and corresponding data_table_entry (param_entry_t)
 typedef struct {
 ...
 //param_table_t starts at offset tables_entries * 0x10 + 0x14
 typedef struct {
